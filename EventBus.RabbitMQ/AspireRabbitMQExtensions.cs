...
public static class AspireRabbitMQExtensions
{
    ...
    public static void AddRabbitMQ(this IHostApplicationBuilder builder, string connectionName, Action<EventBusRabbitMQ.RabbitMQClientSettings>? configureSettings = null, Action<IConnectionFactory>? configureConnectionFactory = null)
    ...
    public static void AddKeyedRabbitMQ(this IHostApplicationBuilder builder, string name, Action<EventBusRabbitMQ.RabbitMQClientSettings>? configureSettings = null, Action<IConnectionFactory>? configureConnectionFactory = null)
    {
    ...
    private static void AddRabbitMQ(
        ...
        Action<EventBusRabbitMQ.RabbitMQClientSettings>? configureSettings,
        ...
        object? serviceKey)
    {
        ...
        var settings = new EventBusRabbitMQ.RabbitMQClientSettings();
