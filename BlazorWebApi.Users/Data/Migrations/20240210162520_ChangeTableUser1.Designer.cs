...
namespace BlazorWebApi.Users.Data.Migrations
{
    ...
    [Migration("20240210162520_ChangeTableUser1")]
    partial class ChangeTableUser1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorWebApi.Users.Domain.Models.UserRoleClaim", b =>
                {
                    b.HasOne("BlazorWebApi.Users.Domain.Models.UserRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    b.HasOne("BlazorWebApi.Users.Domain.Models.UserRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
